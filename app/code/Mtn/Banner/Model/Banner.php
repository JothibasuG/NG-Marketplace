...
class Banner extends AbstractModel implements BannerInterface, IdentityInterface
{
     ...
     */
    const BASE_IMAGE_MEDIA_PATH = 'mtn/banner/image';

    /**
     * Base media path for banner's image
     */
    const BASE_VIDEO_MEDIA_PATH = 'mtn/banner/video';
     ...
     * @var string
     */
    protected $eventPrefix = 'mtn_banner';
    ...
    {
        $this->_init(\Mtn\Banner\Model\ResourceModel\Banner::class);
    }
